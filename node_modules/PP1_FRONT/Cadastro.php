...
<div class="jumbotron">
    <form class="text-center border border-light p-5" action="../login_cadastro_usuario/cadastro_usuario.php" method="post">
            ...
            <label> 
             ...
             <!-- data de nascimento -->
             <label>  
                 <input type="date" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" id="data_nasc" name="data_nasc" class="form-control" maxlength="10" placeholder="data de nascimento" aria-describedby="defaultRegisterFormPhoneHelpBlock" style="width:500px;font-size: 13px">
                <small id="defaultRegisterFormPhoneHelpBlock" class="form-text text-muted mb-4"></small>
            </label><br>
            <div class="g-recaptcha" data-sitekey="6LeaQJUUAAAAAFCPz5Gg023tY66ZEADgEuRAqk8i"></div>
            <!-- Sign up button -->
