...
if(isset($token_usuario) && $_SESSION['logado']) {
    header('Location: ./'.$_SESSION['urlRequest']);
}

$_SESSION['urlRequest'] = 'Cadastro.php';
            ...
            <body>
              ...
              <label>
                    <?php if(isset($_SESSION['msgLoginFalha'])) : ?>
                            <span style="color: red"><?php echo $_SESSION['msgLoginFalha']; ?></span>
    ...
    <form class="text-center border border-light p-5" action="../login_cadastro_usuario/cadastro_usuario.php" method="post">
                ...
                <div class="col">
                    ...
                    <label>
                        <?php if(isset($_SESSION['msgDeVerificacao'])) : ?>
                            <span style="color: darkred; font-family: Couriew;"><?php echo $_SESSION['msgDeVerificacao']; ?></span>
                        <?php unset($_SESSION['msgDeVerificacao']);
                            endif; ?>
                        ...
                        <?php unset($_SESSION['msgDeVerificacaoNome']);
                            ...
                            <span style="float: left; font-family: Couriew;">Nome</span><br>
            ...
            <label>
                ...
                <?php unset($_SESSION['msgDeVerificacaoEmail']);
                        ...
                        <span style="float: left; font-family: Couriew;">Email</span><br>
            ...
            <label>
                ...
                <?php unset($_SESSION['msgDeVerificacaoSenha']);
                    ...
                    <span style="float: left; font-family: Couriew;">Senha</span><br>
                    <input type="password" id="senha" name="senha" class="form-control" minlength="8" maxlength="14" placeholder="Sua senha" aria-describedby="defaultRegisterFormPasswordHelpBlock" style="width:500px;font-size: 13px" required>
                <small id="defaultRegisterFormPasswordHelpBlock" class="form-text text-muted mb-4"></small>
            </label><br>
            <!-- Nova Senha -->
            <label>
                    <span style="float: left; font-family: Couriew;">Confirme sua senha</span><br>
                    <input type="password" id="conf-senha" name="conf-senha" class="form-control" minlength="8" maxlength="14" placeholder="confirme sua senha" aria-describedby="defaultRegisterFormPasswordHelpBlock" style="width:500px;font-size: 13px" required>
                <small id="defaultRegisterFormPasswordHelpBlock" class="form-text text-muted mb-4"></small>
            </label><br>
            <!-- cpf -->
            <label> 
                <?php if(isset($_SESSION['msgDeVerificacaoCpf'])) : ?>
                        <span style="color: red; font-family: Couriew;"><?php echo $_SESSION['msgDeVerificacaoCpf']; ?></span>
                <?php unset($_SESSION['msgDeVerificacaoCpf']);
                    endif; ?>
                <span id="cpfResponse"></span>
                <span style="float: left; font-family: Couriew;">CPF</span><br>
                <input type="text" id="cpf" name="cpf" class="form-control" maxlength="14" placeholder="xxx.xxx.xxx-xx" aria-describedby="defaultRegisterFormPhoneHelpBlock" style="width:500px;font-size: 13px" value="<?php if(!empty($_SESSION['cpfForm'])) { echo $_SESSION['cpfForm']; }else { echo ''; } ?>" onkeyup="cpfCheck(this)" maxlength="14" onkeydown="javascript: fMasc( this, mCPF );">
                <small id="defaultRegisterFormPhoneHelpBlock" class="form-text text-muted mb-4"></small>
            </label><br>
             <!-- data de nascimento -->
             <label>
                <?php if(isset($_SESSION['msgDeVerificacaoNasc'])) : ?>
                        <span style="color: red; font-family: Couriew;"><?php echo $_SESSION['msgDeVerificacaoNasc']; ?></span>
                <?php unset($_SESSION['msgDeVerificacaoNasc']);
                    endif; ?>
                        <span style="float: left; font-family: Couriew;">Data de Nascimento</span><br>
                    <input type="date" required id="data_nasc" name="data_nasc" class="form-control" aria-describedby="defaultRegisterFormPhoneHelpBlock" style="width:500px;font-size: 13px" value="<?php if(!empty($_SESSION['dataNasc'])) { echo $_SESSION['dataNasc']; }else { echo ''; } ?>">
                <small id="defaultRegisterFormPhoneHelpBlock" class="form-text text-muted mb-4"></small>
            </label><br>
            <div class="g-recaptcha" data-sitekey="6LeaQJUUAAAAAFCPz5Gg023tY66ZEADgEuRAqk8i"></div>
            <!-- Sign up button -->
