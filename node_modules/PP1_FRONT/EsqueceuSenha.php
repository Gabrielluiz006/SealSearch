...
$_SESSION['urlRequest'] = 'EsqueceuSenha.php';
...
<div class="jumbotron">
    <form class="text-center border border-light p-5" action="../login_cadastro_usuario/esqueceuSenha_usuario.php" method="post">
            ...
            <label>
                ...
                <?php unset($_SESSION['msgDeVerificacao']);
                    ...
                    <input type="email" id="redefine-email" name="redefine-email" class="form-control mb-4" maxlength="30" placeholder="Digite seu E-mail" style="width:500px;font-size: 13px">
            </label><br>
            <!-- Sign up button -->
