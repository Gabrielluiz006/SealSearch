...
$_SESSION['urlRequest'] = 'Perfil.php';
...
try {
    ...
    $sql = 'SELECT caminho_foto FROM cliente WHERE email = :email;';
    ...
    if($stmt->execute()) {
        ...
        if($stmt->rowCount() !== 0 || count($result[0]) !== 0) {
            $_SESSION['caminho_foto'] = $result[0]['caminho_foto'];
        }else {
            unset($_SESSION['caminho_foto']);
        }
...
<nav class="navbar navbar-inverse">
  ...
  <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <!-- fim do nav-->
    <div class="container" id="dados-usuario">
		<div class="row">
		<div class="col-md-7 ">
		<div class="panel panel-default">
			...
			<div class="box box-info">
					<div class="box-body">
                                            <div class="col-sm-6">
						<div  align="center">
                                                    <?php if(isset($_SESSION['msgUploadFail'])) : ?>
                                                        <span style="font-family: Coriew;"><?php echo $_SESSION['msgUploadFail']; unset($_SESSION['msgUploadFail']); ?></span>
                                                    <?php endif; ?>
                                                        
                                                        <?php if(isset($_SESSION['caminho_foto'])) : ?>
                                                            <img alt="User Pic" src="<?php echo $_SESSION['caminho_foto']; ?>" id="profile-image1" class="img-circle img-responsive">
                                                        <?php else : ?>
                                                            <img alt="User Pic" src="https://x1.xingassets.com/assets/frontend_minified/img/users/nobody_m.original.jpg" id="profile-image1" class="img-circle img-responsive">
                                                        <?php endif; ?>
                                                            <form method="post" action="../login_cadastro_usuario/recebeUpload_usuario.php" enctype="multipart/form-data">
                                                                <input id="profile-image-upload" type="file" name="foto-usuario">
					...
					<div class="col-sm-6">
					<h4 style="color:#E0851D">Bem-vindo <?php echo $_SESSION['nome']; ?> </h4></span>
                                        <span><p>Compradora ávida.</p></span> 
                                        <button class="btn btn-warning" onclick="editarDados();">Editar</button>
					</div>
                                            <div class="clearfix">
                                            </div>
					<hr style="margin:5px 0 5px 0;">
                <div class="col-sm-5 col-xs-6 tital " class="dados">Nome:</div><div class="col-sm-7 col-xs-6 "><?php echo $_SESSION['nome']; ?></div>
		...
		<div class="bot-border"></div>
                ...
                <div class="clearfix"></div>
		<div class="bot-border"></div>
		<div class="col-sm-5 col-xs-6 tital " >Data de nascimento:</div><div class="col-sm-7"><?php echo $_SESSION['dataNascPerfil']; ?></div>
                <div class="clearfix"></div>
		<div class="bot-border"></div>
