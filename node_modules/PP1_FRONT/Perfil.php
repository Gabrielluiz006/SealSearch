    ...
    <div class="container" id="dados-usuario">
		...
		<div class="panel panel-default">
			...
			<div class="box box-info">
					...
					<div class="col-sm-6">
					<h4 style="color:#E0851D"> O nome dela é Jeniffer </h4></span>
                                        <span><p>Compradora ávida.</p></span> 
                                        <button class="btn btn-warning" onclick="editarDados();">Editar</button>           
					</div>
					<div class="clearfix"></div>
					<hr style="margin:5px 0 5px 0;">
                <div class="col-sm-5 col-xs-6 tital " class="dados">Primeiro nome:</div><div class="col-sm-7 col-xs-6 "><?php echo $_SESSION['nome']; ?></div>
                <div class="clearfix"></div>
		<div class="bot-border"></div>
		<div class="col-sm-5 col-xs-6 tital " >Email:</div><div class="col-sm-7"><?php echo $_COOKIE['email-login']; ?></div>
                <div class="clearfix"></div>
		<div class="bot-border"></div>
