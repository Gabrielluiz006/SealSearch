...
$regex_imagens = '/<img(.*)border="0" height="90" width="90">/';
$matches = array();
preg_match_all($regex_imagens,$url,$matches);

$regex_tirar_imagens = '/title(.*)width="90">/';

for($i=0; $i<30; $i++){
  $exibir[$i] = preg_replace($regex_tirar_imagens,"",$matches[0][$i]);
  //echo $matches[0][$i]."<br>";
  //echo $exibir;
}

$containerPropaganda = '<div class="container">    
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">SITE X</div>
        <div class="panel-body">'.$exibir[1].'></div>
        <div class="panel-footer"><button class="btn btn-warning">Visitar</button></div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-danger">
        <div class="panel-heading">SITE Y</div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-success">
        <div class="panel-heading">SITE Z</div>
        <div class="panel-body"><img src="https://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer"><button class="btn btn-warning">Visitar</button></div>
      </div>
    </div>
...
<div class="container">    
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">SITE W</div>
        <div class="panel-body"><img src="https://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer"><button class="btn btn-warning">Visitar</button></div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        <div class="panel-heading">SITE A</div>
        <div class="panel-body"><img src="https://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer"><button class="btn btn-warning">Visitar</button></div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        <div class="panel-heading">SITE B</div>
        <div class="panel-body"><img src="https://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:100%" alt="Image"></div>
