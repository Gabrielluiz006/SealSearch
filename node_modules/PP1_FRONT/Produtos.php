...
<div class="container" id ="back">    
 ...
 <?php
    $stmt = $pdo->prepare("select tag from propaganda where nome_empresa = 'kabum' limit $inicioExibir, $numPorPagina");
    $stmt->execute();
    $resultado_kabum = $stmt->fetchAll(PDO::FETCH_ASSOC);

    $stmt = $pdo->prepare("select tag from propaganda where nome_empresa = 'pichau' limit $inicioExibir, $numPorPagina");
    $stmt->execute();
