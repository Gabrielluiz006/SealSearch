  ...
  //CONTAINERS DAS PROPAGANDAS
    $containerPropaganda = '  <div class="col-sm-4">
        <div class="panel panel-primary">
            <div class="panel-heading">'.$exibir_logo.'<a href="../login_cadastro_usuario/adicionar_carrinho.php?produto='.$i.'&loja=Kabum" id="estrela"></a></div>
            <div class="panel-body" id="tamanho">'.$exibir[$i]."<br>$exibir_des[$i]".'</div>
            <div class="panel-footer">
                <button class="btn btn-warning">clique para comprar</button>
            </div>
        </div>
        <hr>
      </div>
