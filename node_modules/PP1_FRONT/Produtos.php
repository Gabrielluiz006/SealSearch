...
//EXPRESSÃP REGULAR PARA EDITAR PARTE DA TAG HTML DA LOGO
...
$regex_desc = '/"margin:0 0 5px 0;">(.+)<\/span>/';
$matches_desc = array();
...
$containerPropaganda = '  <div class="col-sm-4">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">'.$exibir[$i]."<br>$exibir_des[$i]".'</div>
