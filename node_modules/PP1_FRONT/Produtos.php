...
<div class="container" id ="back">    
 ...
 <?php
    ...
    $stmt = $pdo->prepare("select tag from propaganda limit $inicioExibir, $numPorPagina");
    $stmt->execute();
    ...
    /*$stmt = $pdo->prepare("select tag, id from propaganda where nome_empresa = 'kabum'");
...
<?php
//PEGA AS IMAGENS
$url = file_get_contents("https://www.pichau.com.br/hardware/placa-de-video?product_list_limit=48");
$regex ='/<img class="product-image-photo"\n(\s)+s(.)+\s+(.)+(\D)+(.)+\s+alt="[a-zA-z0-9\s,-]+"\/>/';
$matches = array();
preg_match_all($regex,$url,$matches);

//PEGA OS PRECOS
$regex ='/<span>à vista(\s[R](.){1}[0-9.,0-9]+)<\/span>/';
$array = array();
...
//SELECT PARA PEGAR O ID DO PRODUTO SELECIONADO
...
for($i = 0; $i<29; $i++){
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">'.$logo.'<a href="../login_cadastro_usuario/adicionar_carrinho.php?produto='.$i.'&loja=Pichau" id="estrela"></a></div>
