...
if(empty($_SESSION['logado']) || empty($token_usuario) || !$_SESSION['logado']) {
    header('Location: ../login_cadastro_usuario/logout_usuario.php');
}

$_SESSION['urlRequest'] = 'Alterar.php';
...
<div class="jumbotron">
    <form class="text-center border border-light p-5" action="../login_cadastro_usuario/alteraDados_usuario.php" method="post">
        <p class="h4 mb-4">Alterar dados</p>
        <div class="form-row mb-4">
            ...
            <label>
                ...
                <?php unset($_SESSION['msgDeVerificacaoNome']);
                    ...
                    <input type="text" id="altera-nome" name="altera-nome" class="form-control" maxlength="30" placeholder="Seu nome" style="width:500px;font-size: 13px" value="<?php if(!empty($_SESSION['nome'])) { echo $_SESSION['nome']; }else { echo ''; } ?>">
                </label> <br>
            </div>
            <div class="col">
            </div>
        ...
        <label>
            ...
            <?php unset($_SESSION['msgDeVerificacaoEmail']);
                    ...
                    <input type="email" id="altera-email" name="altera-email" class="form-control mb-4" maxlength="30" placeholder="E-mail" style="width:500px;font-size: 13px" value="<?php if(!empty($_COOKIE['email-login'])) { echo $_COOKIE['email-login']; }else { echo ''; } ?>">
        </label><br>
        <!-- Senha -->
        <label>
            ...
            <?php unset($_SESSION['msgDeVerificacaoSenha']);
                ...
                <input type="password" id="altera-senha" name="altera-senhaAntiga" class="form-control" maxlength="10" placeholder="Sua senha" aria-describedby="defaultRegisterFormPasswordHelpBlock" style="width:500px;font-size: 13px">
            <small id="defaultRegisterFormPasswordHelpBlock" class="form-text text-muted mb-4"></small>
        </label><br>
        <!-- Senha Nova-->
        <label>
            <input type="password" id="altera-senhaNova" name="altera-senhaNova" class="form-control" maxlength="10" placeholder="Nova senha" aria-describedby="defaultRegisterFormPasswordHelpBlock" style="width:500px;font-size: 13px">
            <small id="defaultRegisterFormPasswordHelpBlock" class="form-text text-muted mb-4"></small>
        </label><br>
            <!-- cpf -->
        <label> 
            <input type="text" id="altera-cpf" name="altera-cpf" class="form-control" maxlength="11" placeholder="Seu cpf" aria-describedby="defaultRegisterFormPhoneHelpBlock" style="width:500px;font-size: 13px" value="<?php if(!empty($_SESSION['cpf'])) { echo $_SESSION['cpf']; }else { echo ''; } ?>" readonly>
            <small id="defaultRegisterFormPhoneHelpBlock" class="form-text text-muted mb-4"></small>
        </label> <br>
             <!-- data de nascimento -->
        <label>  
            <input type="date" id="altera-data_nasc" name="altera-dataNasc" class="form-control" maxlength="10" placeholder="data de nascimento" aria-describedby="defaultRegisterFormPhoneHelpBlock" style="width:500px;font-size: 13px" value="<?php if(!empty($_SESSION['dataNasc'])) { echo $_SESSION['dataNasc']; }else { echo ''; } ?>">
            <small id="defaultRegisterFormPhoneHelpBlock" class="form-text text-muted mb-4"></small>
        </label> <br>
        <!-- Sign up button -->
        <input class="btn btn-warning" type="submit" name="alterar" style="width:500px;font-size: 13px;" value="Alterar">
        <hr> 
    </form>
</div>
              <!-- fim do formulÃ¡rio-->
