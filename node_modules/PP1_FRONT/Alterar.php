    ...
    <form class="text-center border border-light p-5" action="../login_cadastro_usuario/alteraDados_usuario.php" method="post">
        ...
        <div class="form-row mb-4">
            ...
            <label>
                ...
                <?php unset($_SESSION['msgDeVerificacaoNome']);
                    ...
                    <input type="text" id="altera-nome" name="altera-nome" class="form-control" maxlength="30" placeholder="Seu nome" style="width:500px;font-size: 13px" value="<?php if(isset($_SESSION['nome'])) { echo $_SESSION['nome']; }else { echo ''; } ?>">
                </label> <br>
            </div>
            <div class="col">
            </div>
        ...
        <label>
            ...
            <?php unset($_SESSION['msgDeVerificacaoEmail']);
                    ...
                    <input type="email" id="altera-email" name="altera-email" class="form-control mb-4" maxlength="30" placeholder="E-mail" style="width:500px;font-size: 13px" value="<?php if(isset($_COOKIE['email-login'])) { echo $_COOKIE['email-login']; }else { echo ''; } ?>">
        </label><br>
        <!-- Senha -->
        <label>
        ...
        <label>
            ...
            <!-- cpf -->
        <label> 
            <input type="text" id="altera-cpf" name="altera-cpf" class="form-control" maxlength="11" placeholder="Seu cpf" aria-describedby="defaultRegisterFormPhoneHelpBlock" style="width:500px;font-size: 13px" value="<?php if(isset($_SESSION['cpf'])) { echo $_SESSION['cpf']; }else { echo ''; } ?>" readonly>
            <small id="defaultRegisterFormPhoneHelpBlock" class="form-text text-muted mb-4"></small>
        </label> <br>
             <!-- data de nascimento -->
        <label>  
            <input type="date" id="altera-data_nasc" name="altera-dataNasc" class="form-control" maxlength="10" placeholder="data de nascimento" aria-describedby="defaultRegisterFormPhoneHelpBlock" style="width:500px;font-size: 13px" value="<?php if(isset($_SESSION['dataNasc'])) { echo $_SESSION['dataNasc']; }else { echo ''; } ?>">
            <small id="defaultRegisterFormPhoneHelpBlock" class="form-text text-muted mb-4"></small>
        </label> <br>
        <!-- Sign up button -->
