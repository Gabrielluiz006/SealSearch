...
<div class="jumbotron">
    <form class="text-center border border-light p-5" action="../login_cadastro_usuario/altera_usuario.php" method="post">
        ...
        <label> 
            ...
            <small id="defaultRegisterFormPhoneHelpBlock" class="form-text text-muted mb-4"></small>
             ...
             <!-- data de nascimento -->
        <label>  
            <input type="text" id="altera-data_nasc" name="altera-dataNasc" class="form-control" maxlength="10" placeholder="data de nascimento" aria-describedby="defaultRegisterFormPhoneHelpBlock" style="width:500px;font-size: 13px" value="<?php if(!empty($_SESSION['dataNasc'])) { echo $_SESSION['dataNasc']; }else { echo ''; } ?>">
            <small id="defaultRegisterFormPhoneHelpBlock" class="form-text text-muted mb-4"></small>
        </label> <br>
        <!-- Sign up button -->
