...
<div class="jumbotron">
    <form class="text-center border border-light p-5" action="../login_cadastro_usuario/trocaSenha_usuario.php" method="post">
            <p class="h4 mb-4">Digite seu email para redefinir sua senha</p>
            <!-- Senha -->
            <label>
                <input type="email" name="email" value="<?php if(isset($_GET['email'])) { echo $_GET['email']; }else { echo ''; } ?>" hidden>
                <input type="text" name="token" value="<?php if(isset($_GET['token'])) { echo $_GET['token']; }else { echo ''; } ?>" hidden>
                ...
                <?php unset($_SESSION['msgDeVerificacao']);
                        ...
                        <input type="password" id="nova-senha" name="nova-senha" class="form-control mb-4" maxlength="30" placeholder="Nova senha" style="width:500px;font-size: 13px">
                        <br>
                        <input type="password" id="conf-senha" name="conf-senha" class="form-control mb-4" maxlength="30" placeholder="Confirme sua senha" style="width:500px;font-size: 13px">
            </label><br>
            <!-- Sign up button -->
            <input class="btn btn-warning" type="submit" name="esqueceu-senha" style="width:500px;font-size: 13px;" value="Enviar">
            <hr> 
        </form>
        </div>
              <!-- fim do formulÃ¡rio-->
