            ...
            <body>
              ...
              <label> 
                  ...
                  <input type="password" id="defaultLoginFormPassword" class="form-control mb-4" placeholder="Password" style="width:450px;font-size: 13px">
                      ...
                      <div class="container" style="color: #E0851D">
                        <div class="row">
                            <div class="col-xs-8">
                                <div class="panel panel-info">
                                    <div class="panel-heading" style="color: #E0851D">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                <h4 class="product-name"><strong>Nome produto</strong></h4><h4><small>Descrição do produto</small></h4>
                                            </div>
                                            <div class="col-xs-6">
                                                ...
                                                <div class="col-xs-2">
                                                    <button type="button" class="btn btn-link btn-xs">
                                                        <span class="glyphicon glyphicon-trash" style="color: #E0851D"> </span>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="text-center">
                                                <div class="col-xs-9">
                                                    <h6 class="text-right">Quer adicionar algum item?</h6>
                                                </div>
                                                <div class="col-xs-3">
