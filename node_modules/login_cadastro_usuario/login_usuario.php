            ...
            if($stmt->execute()) {
                ...
                if(($stmt->rowCount() === $qtdParamSql || count($result[0]) === $qtdParamSql) && hash_equals($result[0]['senha'], $senha)) {
                    ...
                    if($stmt->execute()) {
                        ...
                        // setando a data no formato do brasil
                        $data_ano = substr($_SESSION['dataNasc'], 0, 4);
                        $data_mes = substr($_SESSION['dataNasc'], 5, 2);
                        $data_dia = substr($_SESSION['dataNasc'], -2);
                        $_SESSION['dataNascPerfil'] = "$data_dia/$data_mes/$data_ano";
