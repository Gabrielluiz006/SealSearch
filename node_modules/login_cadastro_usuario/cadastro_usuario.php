...
try {
    ...
    if(empty($nome) || strlen($nome) > 30 || empty($email) || strlen($email) > 30 || empty($senha) || strlen($senha) < 8 || strlen($senha) > 14 || $senha !== $confSenha || empty($cpf) || !$cpfValido || empty($dataNasc)) {
        ...
        if(empty($senha)) {
            ...
            $_SESSION['msgDeVerificacaoSenha'] = 'A senha deve ser de 8 caracteres no minino';
        }else if(strlen($senha) > 14) {
            $_SESSION['msgDeVerificacaoSenha'] = 'A senha deve ser de 14 caracteres no máximo';
        }else if($senha !== $confSenha) {
            $_SESSION['msgDeVerificacaoSenha'] = 'As senhas devem ser iguais';
        }
    ...
    // a partir daqui é o codigo de cadastro
        ...
        // deixa as letras em minusculo e dps converte apenas a primeira letra para maiusculo
